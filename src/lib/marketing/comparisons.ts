...
export const COMPARISONS: Comparison[] = [
  {
    ...
    intro: "Gasti es un bot de WhatsApp con IA para registrar gastos. Mangui es una app de finanzas personales completa, pensada para la plata argentina. Te mostramos las diferencias sin vueltas.",
    rows: [
      ...
      { feature: "Funciona sin depender de WhatsApp / Meta", mangui: y(), rival: n("vive en WhatsApp") },
      ...
      { feature: "Presupuestos, metas y recurrentes", mangui: y(), rival: p() },
      { feature: "Gastos compartidos / grupos", mangui: n("en el roadmap"), rival: y() },
      { feature: "App web / PWA completa", mangui: y(), rival: p("dashboard secundario") },
      { feature: "Precio", mangui: y("en pesos (MercadoPago)"), rival: p("en dólares") },
    ],
    cuandoMangui: "Si querés entender la plata argentina a fondo (3 dólares, cuotas, resúmenes de tarjeta), pagar en pesos, y no depender de la política de WhatsApp.",
    cuandoRival: "Si te alcanza con registrar gastos sin abrir otra app (WhatsApp ya lo tenés abierto) y dividís gastos en grupo ahí.",
    faq: [
      { q: "¿Mangui o Gasti?", a: "Gasti es cómodo si vivís en WhatsApp y solo querés anotar gastos. Mangui va más a fondo con la realidad argentina (tres dólares, cuotas con resumen, multimoneda) y cobra en pesos." },
      { q: "¿Mangui también carga por voz y foto?", a: "Sí. Le hablás a Manguito o le sacás una foto al ticket y la IA completa el movimiento — sin depender de WhatsApp." },
